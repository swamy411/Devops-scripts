...
#echo aws cloudformation "${OPERATION}-stack" --stack-name "${STACK_NAME}" --template-body file://devops/cloudformation/lambdas.yaml --region "${REGION_NAME}" --capabilities CAPABILITY_AUTO_EXPAND CAPABILITY_IAM CAPABILITY_NAMED_IAM
